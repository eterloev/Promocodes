...
@section('content')
    <div class="h-screen bg-white flex flex-col space-y-10 justify-center items-center">
        <div class="bg-white w-96 shadow-xl rounded p-5">
            ...
            <form method="POST" action="{{ route("loginAction") }}" class="space-y-5 mt-5">
                @csrf
                ...
                <div>
                    <a href="placeholder" class="font-medium text-blue-900 hover:bg-blue-300 rounded-md p-2">Забыли пароль?</a>
                </div>
